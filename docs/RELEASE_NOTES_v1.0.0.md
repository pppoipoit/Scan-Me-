...
- ✅ **PowerShell 7+** (JSON output verified identical to 5.1 by `tests\cross_host_json_test.ps1`)
...
- ✅ Feature tests for HTML dropdowns, copy actions, icon mapping, context-menu behavior, and cross-host JSON stability
